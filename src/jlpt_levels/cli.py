...
def _package(args: argparse.Namespace) -> int:
    result = build_dictionary(
        ...
        Path(args.vocabulary_registry), Path(args.jitendex_lock), Path(args.output_dir), revision=args.revision,
...
def parser() -> argparse.ArgumentParser:
    ...
    package.add_argument("--vocabulary-registry", default="config/vocabulary-sources.json")
